...
def run_me
  ...
  s3_client = Aws::S3::Client.new(
    :access_key_id     => 'ASIAZKZSPJAIOTLJYVXK',
    :secret_access_key => 'aws_secret_access_key=qoiFaKZrEzzi7trnxgtSa17p9k9XVBV31bfebupC',
    :session_token => ''
  )
  puts (s3_client)
